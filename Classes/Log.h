...
//log文件路径    
#define LOG_FILE_NAME "GameWorldlog.txt"    
...
//用下面这些宏来使用本文件    
#define MYLOG(x)              CLog::WriteLog(x);          //括号内可以是字符串(ascii)、整数、浮点数、bool等    
#define MYLOG2(x1,x2)     CLog::WriteLog2(x1,x2);    
#define LOG_FUNC        MYLOG(__FUNCTION__)               //输出当前所在函数名    
#define LOG_LINE        MYLOG(__LINE__)                       //输出当前行号    
